module github.com/vibrantgio/cadence/shell
...
require (
	...
	github.com/vibrantgio/cadence/navbar v0.0.0
	github.com/vibrantgio/cadence/sidebar v0.0.0
...
require (
	...
	github.com/vibrantgio/prism/layout v0.0.0 // indirect
...
replace (
	github.com/vibrantgio/cadence/navbar => ../navbar
	github.com/vibrantgio/cadence/sidebar => ../sidebar
